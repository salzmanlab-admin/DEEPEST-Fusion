...
if __name__ == "__main__":
    ...
    parser.add_argument('-o', '--outDir', help='directory to output files. Will be created if it does not exist.',
                        required=True)
    parser.add_argument('-t', '--juncType', help='type of junction to limit to', choices=['reg', 'rev', 'dup'],
                        required=True)
    parser.add_argument('-b', '--bounds', help='type of junction to limit to', choices=['all', 'within', 'between'],
                        default='all')
